...
> A responsive single-page application for discovering and tracking anime using real-time data.  

- Integrated Jikan API for live content  
- Implemented dynamic routing, filtering, and pagination
- Integrated Firebase for user authentication and personalized watchlists

🔗 <https://myanime-discover.vercel.app>

#### 🥑 SmartFruit

> A mobile application using image recognition to support diabetic dietary decisions.

- Uses a custom-trained image recognition model for fruit classification
- Displays nutritional data and glycemic insights
- Includes intake tracking to support daily health monitoring

🔗 <https://gitlab.com/jadedelimavillar>
